            ...
            <div className="container">
                <div className="container-inner">
                    ...
                    <div className="row project-masonry-active overflow-hidden">
                        {filteredProjects.map(({ category, id, src, title, url }) => <Card key={id} id={id} category={category} src={src} title={title} url={url} animationClass={animationClass} />)}
...
const Card = ({ category, title, src, url, animationClass, id }) => {
    return (
            ...
            <SlideUp delay={id}>
                <div className="project-item style-two">
                    <div className="project-image">
                        ...
                        <Link href={url || "/single-project"} target="_blank" rel="noopener noreferrer" className="details-btn"><RiArrowRightUpLine /> </Link>
                    </div>
